  ...
  return (
    <section id="about" className={styles.container}>
      ...
      <div className={styles.aboutContainer}>
        ...
        <p>
        Olá, sou Larissa, desenvolvedora Full Stack e mestranda em Ciência da Computação no CIN-UFPE. Com foco em Engenharia de Software, minha pesquisa busca aprimorar a avaliação da maturidade de projetos usando técnicas de IA. Tenho experiência em TypeScript, JavaScript, NextJS, ReactJS, Python e Django, criando soluções inovadoras que unem tecnologia e design.
        </p>
